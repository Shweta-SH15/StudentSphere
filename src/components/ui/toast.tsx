...
// 🧭 Viewport positioning (bottom-right)
...
// 🎨 Toast Variants (default, success, info, warning, destructive)
const toastVariants = cva(
  "group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-lg border p-5 pr-8 shadow-lg transition-all " +
    "data-[state=open]:animate-in data-[state=open]:fade-in-90 data-[state=open]:slide-in-from-bottom-5 " +
    "data-[state=closed]:animate-out data-[state=closed]:fade-out-80 data-[state=closed]:slide-out-to-right-5",
  {
    variants: {
      variant: {
        ...
        info: "border-blue-500 bg-blue-50 text-blue-800 dark:border-blue-600 dark:bg-blue-900/30 dark:text-blue-300",
        warning:
          "border-yellow-500 bg-yellow-50 text-yellow-800 dark:border-yellow-600 dark:bg-yellow-900/30 dark:text-yellow-300",
        destructive:
...
// 🔔 Toast Component (with auto-dismiss + icon support)
