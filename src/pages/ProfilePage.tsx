...
//   // 2) Populate form when user changes
//   useEffect(() => {
//     if (!user) return;
//     setName(user.name || "");
...
//   // helper for toggling checkbox arrays
...
//         "immigrantConnect_user",
//         JSON.stringify({ ...user, profileImage: data.imageUrl })
//       );
