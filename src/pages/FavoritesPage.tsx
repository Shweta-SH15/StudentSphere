  ...
  //         if (!fRes.ok) console.error("Friends fetch error:", await fRes.json());
  //         if (!rRes.ok) console.error("Roommates fetch error:", await rRes.json());
  //         if (!aRes.ok) console.error("Accommodations fetch error:", await aRes.json());
  //         if (!restRes.ok) console.error("Restaurants fetch error:", await restRes.json());
